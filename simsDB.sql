...
CREATE TABLE `adpost` (
  ...
  `product_catagory` varchar(45) NOT NULL,
  ...
  PRIMARY KEY  (`id`),
  KEY `FK_adpost_1` (`userid`),
  CONSTRAINT `FK_adpost_1` FOREIGN KEY (`userid`) REFERENCES `advertaizer` (`id`)
...
/*!40000 ALTER TABLE `adpost` DISABLE KEYS */;
/*!40000 ALTER TABLE `adpost` ENABLE KEYS */;


--
-- Definition of table `advertaizer`
--

DROP TABLE IF EXISTS `advertaizer`;
CREATE TABLE `advertaizer` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
--
-- Dumping data for table `advertaizer`
--

/*!40000 ALTER TABLE `advertaizer` DISABLE KEYS */;
/*!40000 ALTER TABLE `advertaizer` ENABLE KEYS */;
...
INSERT INTO `course` (`cid`,`course_name`,`course_hours`,`fees`,`batch_name`,`module`,`schedule`) VALUES 
 (1,'J2EE',940,250000,'TCLD-r36-A/01',10,'EVENING'),
...
INSERT INTO `user` (`uid`,`username`,`uemail`,`upassword`,`uroleid`) VALUES 
 (2,'Nokia','5000','01670015319',1),
 (6,'Toyaota Car','1500000','01670000000',3),
 (7,'Land for sell','please contact for price','01680000001',2);
